...
class MSCOCOSeq(BaseVideoDataset):
    ...
    def get_frames(self, seq_id=None, frame_ids=None, anno=None,dtype='train'):
        ...
        #         # draw_gt(img,gt=anno,savefig_path='/home/user-njf88/hl/data_show/org.jpg')
        #         motion_generator = Motion(img,anno)
        #         im_new,gt_new = motion_generator()
        #         frame_list[i] = im_new
        #         gt_new = gt_new.astype(np.float32)
        #         # draw_gt(im_new,gt=gt_new,savefig_path='/home/user-njf88/hl/data_show/trans.jpg')
