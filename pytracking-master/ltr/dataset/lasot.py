...
class Lasot(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None):
        ...
        self.sequence_list = self._build_sequence_list(vid_ids, split) #所有的训练序列详细名称
    ...
    def build_sample_dict(self):
        ...
        for seq_id in range(len(self.sequence_list)):
            ...
            if len(valid_ids) != 0:
                ...
                sampled_dict[seq_id] = []
        print("lasot[%d] sample %d frames per sequence done!"%(len(self.sequence_list),sample_frame_number))
        return sampled_dict
    ...
    def get_sequence_info(self, seq_id):
        ...
        #     if a!=b:
        #         print(bbox[i])
        visible = self._read_target_visible(seq_path) & valid2.byte()
